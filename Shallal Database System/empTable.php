    ...
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item" role="presentation"><a class="nav-link" href="table.php"><i class="fas fa-pizza-slice"></i><span>Food category</span></a></li>
                </ul>

                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item" role="presentation"><a class="nav-link" href="table.php"><i class="fas fa-pizza-slice"></i><span>Food</span></a></li>
                </ul>
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item" role="presentation"><a class="nav-link" ><i class="fas fa-user-alt"></i><span>Employees</span></a></li>
                </ul>
...
<div>
 ...
 <button class="btn btn-primary" onclick="openForm()"><strong>+ Add EMP</strong></button>
...
----------->
 ...
 <div  class="login-popup">
       <div class="form-popup" id="popupForm">
         <form  method = "post" id = "popwin" scrolling="yes" action="addEMP.php" class="form-container">
           <h2>Fill item info</h2>

           <input type="text" id="EMPFName" placeholder="Emp First name" name="EMPFName" required>


           <input type="text" id="EMPLName" placeholder="EMP Last Name" name="EMPLName" required>
           <input type="text" id="EMPPwd" placeholder="EMP Password" name="EMPPwd" required>
...
<option>Choose EMP Status</option>';

           $sqli = "SELECT SName FROM status";
...
END
     ...
     <div  class="login-popup">
           <div class="form-popup" id="popupFormEdit">
             <form  method = "post" id = "popwin" scrolling="yes" action="editEmp.php" class="form-container">
               <h2>Fill item info</h2>


               <input type="text" id="EmpID" placeholder="Emp ID" name="EmpID" required>
               <input type="text" id="EmpNewFName" placeholder="New First Name" name="EmpNewFName" required>
               <input type="text" id="EmpNewLName" placeholder="New Last Name" name="EmpNewLName" required>
               <input type="text" id="EmpNewPwd" placeholder="New Password" name="EmpNewPwd" required>
     ...
     <option>Choose Emp Status</option>';
               ...
               <button type="submit" class="btn"  onclick="closeForm()Edit" style="background-color:#cc00c0">Submit</button>
         ...
         <div  class="login-popup" >
               <div class="form-popup" id="DeleteForm" >
                 <form  method = "post" id = "Deletepop" scrolling="yes" action="DeleteEMP.php" class="form-container" focus>
                   <h4>Delete EMP </h4>
...
<!--modal end-->
                                ...
                                <a class="btn btn-success btn-icon-split" role="button"></a><label></label></div>                            </div>
                        </div>
    ...
    <table class="table dataTable my-0" id="dataTable">
      ...
      include 'conn.php';
          $sql = "SELECT e.EID, e.Fname, e.Lname, s.SName FROM Employee as e join Status as s  on e.StsID = s.StsID";
          $result = $conn->query($sql);
          if ($result->num_rows > 0) {
            echo "<table class=\"table dataTable my-0\">";
          while($row = $result->fetch_assoc()) {
          echo "<tr>
          <td width = \"15%\" >" . $row["EID"] . "</td>
          <td width = \"23%\">" . $row["Fname"] . "</td>
          <td width = \"28%\">". $row["Lname"]. "</td>
          <td width = \"21%\">". $row["SName"]."</td>
          </tr>" ;
          }
          echo "</table>";
          } else { echo "0 results"; }
