    ...
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item" role="presentation"><a class="nav-link"><i class="fas fa-pizza-slice"></i><span>Food Category</span></a></li>
                </ul>
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
...
<div  class="login-popup">
      <div class="form-popup" id="popupForm">
        <form  method = "post" id = "popwin" scrolling="yes" action="addCat.php" class="form-container">
          <h2>Fill item info</h2>

          <input type="text" id="CatName" placeholder="Category Name" name="CatName" required>

          <input type="text" id="CatDescr" placeholder="Description" name="CatDescr" required>
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
<div  class="login-popup" >
      <div class="form-popup" id="EditCatForm" >
        <form  method = "post" id = "Editpop" scrolling="yes" action="EditCat.php" class="form-container" focus>
          <h4>Update item </h4>


          <div style="text-align:left">
            <input type="text" id="CatID" placeholder="item ID" name="CatID" required style="width: 100%; text-align: left">
          ...
          <?php
          $conn = mysqli_connect("localhost", "root", "", "ssds");
          ...
          echo '<select class = "btn btn-primary" style="background-Color:#000000" id="CatSTS" name="CatSTS">
                <option>Choose Food Category Status</option>';

          $sqli = "SELECT SName FROM status where ststid=2";
          $result = mysqli_query($conn, $sqli);
...
<div  class="login-popup" >
      <div class="form-popup" id="DeleteForm" >
        <form  method = "post" id = "Editpop" scrolling="yes" action="DeleteCat.php" class="form-container" focus>
          <h4>Update item </h4>


          <div style="text-align:left">
            <input type="text" id="CatDelete" placeholder="item ID" name="CatDelete" required style="width: 60%; text-align: left">
...
<!--modal end-->
    ...
    <table class="table dataTable my-0" id="dataTable">
        ...
        <tbody>
          ...
          $sql = "SELECT c.CFID, c.name, s.SName, c.Descr FROM foodcategory  as c join Status as s  on c.StsID = s.StsID ";
          $result = $conn->query($sql);
          if ($result->num_rows > 0) {
            echo "<table class=\"table dataTable my-0\">";
          while($row = $result->fetch_assoc()) {
          echo "<tr>
          <td width = \"25%\" >" . $row["CFID"] . "</td>
          <td width = \"25%\">" . $row["name"] . "</td>
          <td width = \"25%\">".$row["Descr"]."</td>
          <td width = \"25%\">". $row["SName"]. "</td>" ;
          }
          echo "</table>";
          } else { echo "0 results"; }
          $conn->close();
