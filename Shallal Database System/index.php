    ...
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="foodCat.php"><i class="fas fa-pizza-slice"></i><span>Food Category</span></a></li>
                </ul>

                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="table.php"><i class="fas fa-pizza-slice"></i><span>Food</span></a></li>
                </ul>
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="empTable.php"><i class="fas fa-user-alt"></i><span>Employees</span></a></li>
                </ul>
                    ...
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        ...
                        <ul class="nav navbar-nav flex-nowrap ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow" role="presentation">
                                ...
                                </span><img class="border rounded-circle img-profile" src="assets/img/avatars/avatar2.jpeg"></a>
...
From Date:<input type="date" name="fromDate" placeholder="Enter From date" value = "0000-00-00"></input>
To Date:<input type="date" name="toDate" placeholder="Enter To date" value = "0000-00-00"></input>
...
echo '<select   id ="itemCat" name="itemCat">
...
<button  name "GO">Generate</button>
