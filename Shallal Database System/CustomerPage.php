        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li role="presentation" class="nav-item"><a class="nav-link"><i class="fas fa-tachometer-alt"></i><span>Orders</span></a></li>
                </ul>
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
...
==========================================================================
-->
<form   method="post" action="addOnlineOrder.php"   id = "popwin"  class="form-container">
  <h2>Fill Order</h2>
   <?php
...
<form method = "post " action ="FinalizeOrderCustomer.php">
